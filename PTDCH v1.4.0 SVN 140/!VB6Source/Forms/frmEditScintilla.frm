...
4: If blnUpDateOnlyGoToLine Then GoTo Hell
                
    Select Case intTblSelected
        Case 1
6:            pictOptions.Visible = True
7:            cmbFind.Visible = True
8:            picCmds(0).Visible = True
9:            picLbls(0).Visible = True
            '
11:            cmbReplace.Visible = False
12:            picCmds(1).Visible = False
13:            picLbls(1).Visible = False
14:            picGoTo.Visible = False
15:            lblReplace.Visible = False
        Case 2
16:            pictOptions.Visible = True
17:            cmbFind.Visible = True
18:            cmbReplace.Visible = True
19:            picCmds(1).Visible = True
20:            picLbls(1).Visible = True
21:            lblReplace.Visible = True
            '
23:            picCmds(0).Visible = False
24:            picLbls(0).Visible = False
25:            picGoTo.Visible = False
        Case 3
26:            picGoTo.Visible = True
            '
28:            pictOptions.Visible = False
29:            picCmds(0).Visible = False
30:            picCmds(1).Visible = False
31:            picLbls(0).Visible = False
32:            picLbls(1).Visible = False
33:            cmbFind.Visible = False
34:            cmbReplace.Visible = False
35:            lblReplace.Visible = False
36:
Hell:
37:            lblGoTo(2).Caption = lblGoTo(2).Tag & cScintilla.GetCurLine
38:            lblGoTo(4).Caption = lblGoTo(4).Tag & cScintilla.GetLastLine
39:            lblGoTo(3).Caption = lblGoTo(3).Tag & cScintilla.GetColumn

41:            If txtLine.Text = "" Then txtLine.Text = 1
42:            If txtColumn.Text = "" Then txtColumn.Text = 1

44:    End Select
    
46:    lblReplace.Caption = ""
      
48:    Exit Sub
    
50:
Err:
51:    HandleError Err.Number, Err.Description, Erl & "|" & "frmEditScintilla.SetObjects()"
End Sub
...
34:
Err:
35:    HandleError Err.Number, Err.Description, Erl & "|" & "frmEditScintilla.cmbFind_Change()"
End Sub
...
18:
Err:
19:    HandleError Err.Number, Err.Description, Erl & "|" & "frmEditScintilla.cmbReplace_Change()"
End Sub
...
1:    Dim iLine As Long, iCol As Long
...
19:
Err:
20:    HandleError Err.Number, Err.Description, Erl & "|" & "frmEditScintilla.cmdGo_Click()"
End Sub

Private Sub cmdReplace_Click()
1:   Dim iGetPos As Long
  
3:   On Error GoTo Err
    
5:  cScintilla.FindText cmbFind.Text, False, False, chkWrap.Value, chkCase.Value, False, chkWhole.Value, chkRegExp.Value

7:  If cmbReplace.Text <> "" Then
8:    cScintilla.ReplaceSel cmbReplace.Text
9:    cScintilla.SetSel cScintilla.GetCurPos - 1, cScintilla.GetCurPos - 1 + Len(cmbReplace.Text)
10:  Else
11:    iGetPos = cScintilla.GetCurPos
12:    cScintilla.ReplaceSel ""
13:    cScintilla.SetSel iGetPos - LenB(cmbFind.Text), iGetPos - LenB(cmbFind.Text)
14:    cScintilla.FindText cmbFind.Text, False, False, chkWrap.Value, chkCase.Value, False, chkWhole.Value, chkRegExp.Value
15:  End If
  
17:  lblReplace.Caption = ""
    
19:    Exit Sub
    
21:
Err:
22:    HandleError Err.Number, Err.Description, Erl & "|" & "frmEditScintilla.cmdReplace_Click()"
End Sub
...
15:
Err:
16:    HandleError Err.Number, Err.Description, Erl & "|" & "frmEditScintilla.cmdReplaceAll_Click()"
End Sub
...
18:    cmdClose.Caption = g_colMessages.Item("msgClose")
       '
20:    chkWrap.Caption = g_colMessages.Item("msgSCIWrap")
21:    chkWhole.Caption = g_colMessages.Item("msgSCIWhole")
22:    chkCase.Caption = g_colMessages.Item("msgSCICase")
23:    chkRegExp.Caption = g_colMessages.Item("msgSCIRegExp")
       '
25:    lblHolder(0).Caption = g_colMessages.Item("msgSCIFindWhat")
26:    lblHolder(1).Caption = g_colMessages.Item("msgSCIFindWhat")
27:    lblHolder(2).Caption = g_colMessages.Item("msgSCIReplWith")
28:    lblGoTo(0).Caption = g_colMessages.Item("msgSCIDestLine")
29:    lblGoTo(1).Caption = g_colMessages.Item("msgSCIColumn")
       '
31:    lblGoTo(2).Caption = g_colMessages.Item("msgSCICurrLine")
32:    lblGoTo(2).Tag = g_colMessages.Item("msgSCICurrLine")
       '
34:    lblGoTo(3).Caption = g_colMessages.Item("msgSCIColumn")
35:    lblGoTo(3).Tag = g_colMessages.Item("msgSCIColumn")
       '
37:    lblGoTo(4).Caption = g_colMessages.Item("msgSCILastLine")
38:    lblGoTo(4).Tag = g_colMessages.Item("msgSCILastLine")
       '
40:    lblReplace.Tag = g_colMessages.Item("msgSCIReplTimes")

42:   Exit Sub

44:
Err:
45:   HandleError Err.Number, Err.Description, Erl & "|frmEditScintilla.Form_Load()"
End Sub
