...
23:
Err:
24:    HandleError Err.Number, Err.Description, Erl & "|" & "frmProperties_Resize()"
End Sub
...
5:      On Error GoTo Err
        ...
        Select Case Index
           Case 0 'Add
7:               With frmMulti
8:                 .Caption = "Add Property"
9:                 .Label1.Caption = "Enter the name of the new property"
10:                 .Show vbModal, Me
11:                 strName = .txtStr.Text
12:               End With
13:            Set frmMulti = Nothing
               
15:            If LenB(strName) Then
16:               If InStrB(1, strName, " ") Then strName = Replace(strName, " ", "_")
17:               lvwProperties.ListItems.Add , , strName
18:            End If

           Case 1 'Remove
20:            Set lvwItems = lvwProperties.ListItems
            
22:            For Each lvwItem In lvwItems
23:                If lvwItem.Selected Then lvwItems.Remove lvwItem.Index
24:            Next
           Case 2 'Save
25:            PSave
           Case 4
...
31:
Err:
32:    HandleError Err.Number, Err.Description, Erl & "|" & "frmProperties.mnuPropList_Click(" & Index & ")"
End Sub
