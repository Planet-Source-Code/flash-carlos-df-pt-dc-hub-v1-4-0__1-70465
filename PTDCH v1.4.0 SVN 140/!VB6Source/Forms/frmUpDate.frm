...
2:           Unload Me
        Case 1 'Download
3:            g_objFunctions.ShellExec strURL
        Case 2 'Check for updates
4:          m_Notific = False
5:          If m_objUpdate.InUse Then
6:             MsgBoxCenter Me, g_colMessages.Item("msgUpdating"), vbOKOnly, g_colMessages.Item("msgUpdate")
7:          Else
8:             m_objUpdate.Connect
9:          End If
10:      End Select
11:  Exit Sub
...
13:
Err:
14:  HandleError Err.Number, Err.Description, Erl & "|" & "frmUpDate.cmdButton_Click(" & Index & ")"
End Sub
...
6:    Dim datRelease      As Date
    
8:    On Error GoTo Err

10:    Set objXML = New clsXMLParser
    
       'Set data and parse
13:    objXML.Data = strData
14:    objXML.Parse
       
16:    strURL = ""
       
       'Loop through to find properties
19:    For Each objNode In objXML.Nodes(1).Nodes
...
24:    txtVersion(1).Text = strVersion
25:    txtInfo.Text = strMessage
       
       'Compare release dates
28:    If DateDiff("s", vbReleaseDate, datRelease) > 0 Then
29:       If Not m_Notific Then
30:           cmdButton(1).Enabled = True
31:       Else
             'Cut message to correct length
33:          If LenB(strMessage) > 1600 Then _
...
38:          If MsgBox(strMessage & g_colMessages.Item("msgDownload"), vbYesNo Or vbQuestion, strCaption) = vbYes Then
39:             g_objFunctions.ShellExec strURL
40:          End If
41:          Call Unload(Me)
42:       End If
43:    Else
          'No new updates
45:       If Not m_Notific Then
46:          cmdButton(1).Enabled = False
47:       Else
48:          MsgBox g_colMessages.Item("msgMostRecent"), vbOKOnly Or vbInformation, g_colMessages.Item("msgNoUpdate")
49:          Call Unload(Me)
50:       End If
51:    End If
...
55:
Err:
56:    HandleError Err.Number, Err.Description, Erl & "|" & "frmUpDate.m_objUpdate_OnDownloaded(""" & strHeader & """, """ & strData & """)"
End Sub
