...
22:
Err:
23:  HandleError Err.Number, Err.Description, Erl & "|" & "frmBanName.Form_Load()"
End Sub
...
4:    If Me.Tag = "Add" Then
         Select Case g_objRegistered.Add(txtName.Text, txtReason.Text, Locked)
           Case 1
5:           MsgBoxCenter Me, txtName.Text & g_colMessages.Item("msgAlreadyRegged"), vbInformation
           Case 2 'Name longer than 40 chars
6:           MsgBox g_colMessages.Item("msgInvalidBanName"), , g_colMessages.Item("msgBanName"), vbInformation
         'Case 3 'This error should not be returned b/c reasons for banning names don't have limits
8:         End Select
9:   ElseIf Me.Tag = "Rename" Then
10:       g_objRegistered.Rename txtName.Tag, txtName.Text
11:   End If
    
13:   Call cmdClose_Click
    
15:  Exit Sub

17:
Err:
18:  HandleError Err.Number, Err.Description, Erl & "|" & "frmBanName.cmdAddRem_Click()"
End Sub
...
1:   If txtName.Text = "" Then _
          cmdAddRem.Enabled = False _
     Else cmdAddRem.Enabled = True
End Sub
