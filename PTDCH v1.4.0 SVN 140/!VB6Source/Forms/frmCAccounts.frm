...
59:                    For Each objSubNode In colSubNodes
                        Select Case objSubNode.Name
                           Case "Nick"
60:                                strNick = objSubNode.Value
                           Case sPassType
61:                                strPass = objSubNode.Value
                           Case "Profile"
                             Select Case objSubNode.Value
                                   Case sProfileType(0)
62:                                     lngProf = 9 'Super Op
                                   Case sProfileType(1)
63:                                     lngProf = 6  'Op
                                   Case sProfileType(2)
64:                                     lngProf = 5  'Vip
...
66:                                End Select
                             ...
                             Select Case g_objRegistered.Add(strNick, strPass, lngProf, "PtokaX/Database", , True)
                                   Case 0
68:                                     strRsult = "No error"
                                   Case 1
69:                                     strRsult = "Registered already"
                                   Case 2
70:                                     strRsult = "Name longer than 40 chars"
                                   Case 3
71:                                     strRsult = "Password longer than 20 chars"
72:                                End Select
                                
74:                             On Error GoTo Err
                                
76:                             If strRsult = "No error" Then
77:                                Set lvwItems = lvwNoErrors.ListItems
                                'Add listitem
79:                                Set lvwItem = lvwItems.Add(, , Val(i))
80:                                lvwItem.SubItems(1) = strNick
81:                                lvwItem.SubItems(2) = strPass
82:                                lvwItem.SubItems(3) = lngProf
83:                            Else
84:                               Set lvwItems = lvwWithErrors.ListItems
                               'Add listitem
86:                               Set lvwItem = lvwItems.Add(, , Val(i))
87:                               lvwItem.SubItems(1) = strNick
88:                               lvwItem.SubItems(2) = strRsult
89:                               lvwItem.SubItems(3) = strPass
90:                               lvwItem.SubItems(4) = lngProf
91:                            End If
...
102:        txtCount.Text = Val(i - 1)
       
104:        On Error GoTo Err
           
106:        objXML.Clear
        
108:       Set objSubNode = Nothing
109:       Set objNode = Nothing
110:       Set colSubNodes = Nothing
111:       Set colNodes = Nothing

113:       optXMLtype(0).Enabled = True
114:       optXMLtype(1).Enabled = True
115:       cmdConvert.Enabled = False
116:    End If
...
120:
Err:
121:  HandleError Err.Number, Err.Description, Erl & "|" & "frmCAccounts.cmdConvert_Click()"
End Sub

Private Sub cmdBrowse_Click()
1:       Dim cD          As New clsCommonDialog
2:       Dim strNovaPath As String
...
34:
Err:
35:  HandleError Err.Number, Err.Description, Erl & "|" & "frmCAccounts.cmdBrowse_Click()"
End Sub
...
3:     LVFullRow frmCAccounts.lvwNoErrors.hwnd
4:     LVFullRow frmCAccounts.lvwWithErrors.hwnd
...
29:
Err:
30:  HandleError Err.Number, Err.Description, Erl & "|" & "frmCAccounts.Form_Load()"
End Sub
